...
internal class AccountControllerTest {
    ...
    fun getAll() {
        ...
        accountRepository.save(Account(name = "Charles Cabral", document = "12345", phone = "11965984900"))
    ...
    fun findById() {
       ...
       val account = accountRepository.save(Account(name = "Charles Cabral", document = "12345", phone = "11965984900"))
    ...
    fun testCreateAccount() {
        val account = Account(name = "Charles Cabral", document = "12345", phone = "11965984900")
    ...
    fun testUpdateAccount() {
        val account = accountRepository
            .save(Account(name = "Charles Cabral", document = "12345", phone = "11965984900"))
            .copy(name = "updated")
        val json = ObjectMapper().writeValueAsString(account)
